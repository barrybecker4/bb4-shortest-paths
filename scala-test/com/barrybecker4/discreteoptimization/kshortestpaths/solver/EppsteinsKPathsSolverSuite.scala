...
class EppsteinsKPathsSolverSuite extends BaseSolverSuite {
  ...
  override def createSolver(): KShortestPathsSolver = EppsteinsKPathsSolver()

  override def solverName(): String = EppsteinsKPathsSolver.BASE_NAME
}
